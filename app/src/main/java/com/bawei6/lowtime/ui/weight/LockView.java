...
import com.bawei6.lowtime.ui.CodeActivity;
import com.bawei6.lowtime.ui.WelcomeActivity;
...
public class LockView extends View {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    if (check()) {   // 正确图案
                        ...
                        for (int i = 0; i < stateSparseArray.size()-1; i++) {
                    ...
                    timer.schedule(new TimerTask() {
                        ...
                        public void run() {
                            linePath.reset();
                                   startActivity(new Intent(CodeActivity.this, WelcomeActivity.class));
        ...
        private boolean check() {
            ...
            for (int i = 0; i < standardPointsIndexList.size()-1; i++) {
